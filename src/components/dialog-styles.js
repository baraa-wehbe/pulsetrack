export const DIALOG_OVERLAY_CLASS =
  "fixed inset-0 z-50 bg-slate-950/55 backdrop-blur-md motion-safe:animate-in motion-safe:fade-in";

export const DIALOG_CONTENT_CLASS =
  "fixed start-1/2 top-1/2 z-50 max-h-[calc(100dvh-2rem)] w-[min(94vw,52rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-slate-200 bg-white/95 p-5 shadow-2xl backdrop-blur-xl outline-none sm:p-8 rtl:translate-x-1/2 dark:border-slate-700 dark:bg-slate-900/95";
