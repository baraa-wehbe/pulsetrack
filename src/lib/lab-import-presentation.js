...
export const LAB_ROW_STATUS_PRESENTATIONS = Object.freeze({
  ACCEPTED: Object.freeze({
    translationKey: "labRowStatusAccepted",
    className:
      "border-emerald-300 bg-emerald-50 text-emerald-800 dark:border-emerald-800 dark:bg-emerald-950 dark:text-emerald-200",
  }),
  REJECTED: Object.freeze({
    translationKey: "labRowStatusRejected",
    className:
      "border-red-300 bg-red-50 text-red-800 dark:border-red-800 dark:bg-red-950 dark:text-red-200",
  }),
  DUPLICATE: Object.freeze({
    translationKey: "labRowStatusDuplicate",
    className:
      "border-amber-300 bg-amber-50 text-amber-900 dark:border-amber-800 dark:bg-amber-950 dark:text-amber-100",
  }),
});

export const getLabRowStatusPresentation = (status) =>
  LAB_ROW_STATUS_PRESENTATIONS[status] ?? UNKNOWN_PRESENTATION;
