...
export default function PatientDetailsError({ reset }) {
  ...
  return (
    <section
      aria-labelledby="patient-detail-error-heading"
    ...
    >
      <h1
        ...
        id="patient-detail-error-heading"
        ref={headingRef}
        tabIndex={-1}
      >
        <LocalizedText messageKey="patientDetailErrorTitle" />
      </h1>
      <p className="mt-3 text-slate-600 dark:text-slate-300">
        <LocalizedText messageKey="patientDetailErrorDescription" />
      </p>
